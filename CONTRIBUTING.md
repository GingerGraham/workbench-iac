# Contributing to workbench-iac

This is a `workbench` ecosystem module — it doesn't stand alone. It's
installed into a machine via `workbench-core`'s `wb add iac`. Full
...
```sh
git clone https://github.com/GingerGraham/workbench-iac.git
cd workbench-iac
...
wb dev iac
# — or directly:
wb track iac --branch <your-branch>
```
